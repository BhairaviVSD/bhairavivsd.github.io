      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.aboutText}>
            <p>
              I'm Bhairavi Sawantdesai, a Computer Engineering graduate student at NYU with a CGPA of 3.53. I bring over two years of experience at Accenture, where I led CRM engineering, microservices migration, and cloud-native architecture development. I've built robust systems across React-Spring stacks, containerized deployments, and AI pipelines.
            </p>
            <p>
        ...
        <div className={styles.education}>
          ...
          <div className={styles.educationItem}>
            ...
            <div className={styles.eduDetails}>
              ...
              <p className={styles.gpa}>CGPA: 3.53/4</p>
            </div>
          </div>
